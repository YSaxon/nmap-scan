...
class Scanner(NmapScanMethods):
    ...
    def __run(self, method, callback_method:Callable[[Report,NmapScanMethods],None]=None):
    ...
    def scan(self, scan_method:NmapScanMethods, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        self.scan_background(scan_method, callback_method)
        return self.wait(scan_method)

    def scan_background(self, scan_method:NmapScanMethods, callback_method:Callable[[Report,NmapScanMethods],None]=None):
    ...
    def scan_tcp(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.TCP, callback_method)

    def scan_tcp_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.TCP, callback_method)

    def scan_tcp_null(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.TCP_NULL, callback_method)

    def scan_tcp_null_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.TCP_NULL, callback_method)

    def scan_udp(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.UDP, callback_method)

    def scan_udp_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.UDP, callback_method)

    def scan_syn(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.SYN, callback_method)

    def scan_syn_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.SYN, callback_method)

    def scan_fin(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.FIN, callback_method)

    def scan_fin_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.FIN, callback_method)

    def scan_ip(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.IP, callback_method)

    def scan_ip_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.IP, callback_method)

    def scan_sctp_init(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.SCTP_INIT, callback_method)

    def scan_sctp_init_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.SCTP_INIT, callback_method)

    def scan_sctp_cookie(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.SCTP_COOKIE, callback_method)

    def scan_sctp_cookie_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.SCTP_COOKIE, callback_method)

    def scan_xmas(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.XMAS, callback_method)

    def scan_xmas_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.XMAS, callback_method)

    def scan_ping(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.PING, callback_method)

    def scan_ping_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.PING, callback_method)

    def scan_connect(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.CONNECT, callback_method)

    def scan_connect_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.CONNECT, callback_method)

    def scan_ack(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.ACK, callback_method)

    def scan_ack_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.ACK, callback_method)

    def scan_window(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.WINDOW, callback_method)

    def scan_window_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan_background(NmapScanMethods.WINDOW, callback_method)

    def scan_maimon(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
        return self.scan(NmapScanMethods.MAIMON, callback_method)

    def scan_maimon_background(self, callback_method:Callable[[Report,NmapScanMethods],None]=None):
